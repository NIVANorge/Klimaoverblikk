...
PlanktonOrd_01 <- 
  ...
  geom_segment(aes(   x = Art, 
               ...
               linetype="dashed", 
               size=0.1) +   # Draw dashed lines
  labs(title="Fytoplanktongrupper vs DCA1", 
...
PlanktonOrd_02 <- 
  ...
  geom_segment(aes(   x = Art, 
               ...
               linetype="dashed", 
               size=0.1) +   # Draw dashed lines
  labs(title="Fytoplankton vs DCA1", 
       caption="source: phytoplankton data extrated during max Chla (at 5m) during Feb to Apr",
       x="") +  
  coord_flip() +
  theme_classic()
