...
```{r}
write.csv(df_plank_bloom01_mean, "Data_produced/df_plank_bloom01_mean.csv")
write.csv(df_plank_bloom01_median, "Data_produced/df_plank_bloom01_median.csv")
write.csv(df_plank_bloom02, "Data_produced/df_plank_bloom02.csv")
```
