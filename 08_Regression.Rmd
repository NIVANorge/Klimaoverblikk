...
ggsave ("Figures_rapp/Ordination_hydro_rivers.png", width = 7, height = 9, dpi=500)
...
ggsave ("Figures_rapp/Ordination_hydro.png", width = 7, height = 9, dpi=500)
...
ggsave ("Figures_rapp/Ordination_rivers.png", width = 7, height = 9, dpi=500)
...
# appear to be heteroscedadastic, SD increase with mean
# Toms suggested solution to this was Glm with gamma distribution....
...
# the minimum model only includes River_TOC...
full_model <- glm(Hydro_TSM_Deep ~ River_TOC + River_SPM + Winter_NAO + Hydro_DIN_Intermediate + Hydro_Chla_Deep + Hydro_Secchi_Surface, data = dat_sel, family = Gamma(link = "identity"))
summary(full_model)
