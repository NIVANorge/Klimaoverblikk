...
=======
df_bloom1_mean <- read.csv2("Data_produced/df_plank_bloom01_mean.csv", sep = ",", dec=".")
df_bloom1_med  <- read.csv2("Data_produced/df_plank_bloom01_median.csv", sep = ",", dec=".")
df_bloom2      <- read.csv2("Data_produced/df_plank_bloom02.csv", sep = ",", dec=".")
...
# artsmatrise til ordinasjon
spec.bloom1_mean <- df_bloom1_mean[,-1] # fjerner år
...
=======
# tror ikke det er et issue her
spec.bloom1_mean [is.na(spec.bloom1_mean )] = 0
...
=======
ord1 <- decorana(spec.bloom1_mean)
>>>>>>> guri
?decorana
# Pretty longish output
# summary(ord1) # viser arts- og rutescorer
...
=======
ord1.df <- data.frame(df_bloom1_mean[,], ord1.sites)
>>>>>>> guri
